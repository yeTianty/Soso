...
public class CardUtil {
    ...
    public void initScene() {
        MobileCard card1 = new MobileCard("a1", "1234", "13912345679", new SuperPackage(), 78, 72);
        MobileCard card2 = new MobileCard("a2", "1235", "13912345678", new TalkPackage(), 58, 42);
        MobileCard card3 = new MobileCard("a3", "1236", "13987654321", new NetPackage(), 68, 32);
        ...
        scenes.add(new Scene("通话", 90, "打电话，90分钟"));
        scenes.add(new Scene("短信", 50, "短信互动 发送短线50条"));
        scenes.add(new Scene("上网", 2 * 1024, "小视频 使用流量2G"));
